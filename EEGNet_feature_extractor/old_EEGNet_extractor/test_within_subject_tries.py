...
# --- Training Parameters ---
EPOCHS = 50 # Increased epochs because EarlyStopping will find the optimal point
BATCH_SIZE = 32
...
for subject_id in range(1, NUM_SUBJECTS + 1):
    ...
    X, y, groups = load_subject_data(subject_id)
    ...
    y_categorical = np_utils.to_categorical(y, num_classes=CLASSES)
    ...
    for fold_num, (train_idx, test_idx) in enumerate(logo.split(X, y_categorical, groups)):
        ...
        # This will stop training if the validation accuracy does not improve for 15 epochs.
        # It will also restore the weights from the best epoch at the end.
        ...
        # This will reduce the learning rate by half if val_accuracy does not improve for 10 epochs.
        ...
        # Find the epoch with the best validation accuracy to report train metrics
